...
function DarkAndLightMode(props){
  
  const {theme, setThemeName} = props;
  
  return(
    <Container>
    <div className="form-check form-switch offset-11 col-md-1 my-3" >
      ...
      <label className="form-check-label float-start" htmlFor="flexSwitchCheckDefault"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-brightness-high-fill" viewBox="0 0 16 16">
